...
public class View_Activity extends AppCompatActivity {
   ...
   /* String adres = "ul. Święty Marcin 80/82\n61-717 Poznań";
    ...
    String ocena = "4.8";
    String opis = "Centrum Kultury ZAMEK w Poznaniu to jedna z największych instytucji kultury w kraju. " +
